...
В отличие от клиентских конфигураций, данный релиз спроектирован для фильтрации и оптимизации трафика на самом сервере:
...
### 1. Файл `geosite.dat`
Агрегирует и пересобирает доменные зоны из различных доверенных апстримов:
